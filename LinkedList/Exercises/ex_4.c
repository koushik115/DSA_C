...
// Exercise questions
int countOccurence(struct node *start, int item);
void find_min_max(struct node *start);
int checkIdentical(struct node *p1, struct node *p2);
...
int checkIdentical(struct node *start1, struct node *start2)
{
